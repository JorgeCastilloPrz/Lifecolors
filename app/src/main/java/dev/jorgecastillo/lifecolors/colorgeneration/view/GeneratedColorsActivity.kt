...
class GeneratedColorsActivity : AuthenticationActivity() {
    ...
    private fun animateStatusBarEnter() {
        ...
        val colorAnimation =
            ValueAnimator.ofObject(ArgbEvaluator(), transparentColor, selectedColor()).apply {
        ...
        when {
            state.isShowingError -> {
                ...
                if (state.colorName.isEmpty()) {
                    ...
                    selectedColorName.text =
                        resources.getString(R.string.color_name, state.colorName)
                }
    ...
    private fun generateComplimentary(selectedColor: Int) {
        ...
        complimentaryColor.setOnClickListener {
            launchWithNoTransition(
                this,
                selectedColor.complimentary()
            )
        }
